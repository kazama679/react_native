        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollArea}>
                <Text style={styles.content}>
                    ...
                    {"\n\n"}4. Nội dung
                    {"\n"}Dịch vụ của chúng tôi cho phép bạn đăng, liên kết, lưu trữ, chia sẻ và cung cấp một số thông tin, văn bản, đồ họa, video hoặc tài liệu khác. Bạn chịu trách nhiệm về Nội dung mà bạn đăng lên Dịch vụ, bao gồm cả tính hợp pháp, độ tin cậy và sự phù hợp của nó.
                    {"\n\n"}5. Chấm dứt
